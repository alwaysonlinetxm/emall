<?php
    ...
    //建立匹配查询串
	$query = "select bid, goods.gid, gdis, uname, gprice, gfare, gnum, bstatus, btime from bill, goods, user where goods.gid=bill.gid and bill.uid=user.uid and goods.oid='$oid'";
